namespace :data_migration do
  desc "Set up Data Migration Engine (run migrations and seed admin user)"
  task setup: :environment do
    puts "Setting up Data Migration Engine..."
    puts
    ...
    # Seed admin user
    Rake::Task["data_migration:seed"].invoke
  end

  desc "Seed admin user for Data Migration Engine"
  task seed: :environment do
    puts "🌱 Seeding Data Migration Engine..."
    puts
    ...
    puts
    puts "🎉 Data Migration Engine setup completed!"
  end
end